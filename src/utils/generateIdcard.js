...
const generateIDCardsPDF = async (users = []) => {
  ...
  try {
    ...
    for (let i = 0; i < users.length; i++) {
      const user = users[i];
      // const photoUrl = user.photo || "https://www.shutterstock.com/shutterstock/photos/1672482379/display_1500/stock-photo-attractive-young-asian-woman-career-woman-job-hunter-1672482379.jpg";
      ...
      doc.setFontSize(7);
      const header = "INSTITUTE NAME"; // Replace with actual institute name should be dynamic
...
const textStartX = 30; // Shifted further right for more space from the image
let currentY = 18;
...
export default generateIDCardsPDF;
