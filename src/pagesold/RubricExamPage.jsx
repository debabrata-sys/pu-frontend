...
const RubricExamPage = () => {
  ...
  const fetchRubrics = async () => {
    setLoading(true);
    const res = await ep1.get("/api/v2/getallrubrics", {
  ...
  const arrayStructures = {
    ...
    attendancemarks: {
      attendancename: "",
      attendancefull: 0,
      attendanceobtainmark: 0,
    },
    internshipmarks: {
      internshipname: "",
      internshipfull: 0,
      internshipobtainmark: 0,
    },
    extracurriculummarks: {
      extracurriculumname: "",
      extracurriculumfull: 0,
      extracurriculumobtainmark: 0,
    },
  };
            ...
            <Grid item xs={12}>
              ...
              <Button
                onClick={() =>
                  handleAddArrayItem(
                    "attendancemarks",
                    arrayStructures.attendancemarks
                  )
                }
                sx={{ my: 1 }}
              >
            ...
            <Grid item xs={12}>
              ...
              <Button
                onClick={() =>
                  handleAddArrayItem(
                    "internshipmarks",
                    arrayStructures.internshipmarks
                  )
                }
                sx={{ my: 1 }}
              >
            ...
            <Grid item xs={12}>
              ...
              <Button
                onClick={() =>
                  handleAddArrayItem(
                    "extracurriculummarks",
                    arrayStructures.extracurriculummarks
                  )
                }
                sx={{ my: 1 }}
              >
