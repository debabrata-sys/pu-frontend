...
function AddUserModal1({ open, handleClose, handleInputChange, handleAddUser, newUser, fetchViewPage }) {
    ...
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <DialogContent>
        ...
        >
          ...
          <MenuItem value='Counselor1'>Counselor1</MenuItem>
        </Select>
        <br /><br />
