...
export default function ConductExam2ExaminerLetterPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const [exRes, allotRes, cfgRes] = await Promise.allSettled([
        ...
        ep1.get('/api/v2/conductexam2/configuration', { params: { colid } })
      ]);
  ...
  return (
    <MenuPageShell title="Generate Examiner Letter 2">
          ...
          <Accordion defaultExpanded={false} sx={{ mb: 2.5, borderRadius: '8px !important', border: '1px solid #cbd5e1' }}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography fontWeight={700} color="#334155">
                âœï¸ Edit Letter Header, Reference No, Dates &amp; Authorities
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
