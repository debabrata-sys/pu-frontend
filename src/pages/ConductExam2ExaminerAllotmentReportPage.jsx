...
export default function ConductExam2ExaminerAllotmentReportPage() {
  ...
  const loadInstitution = async () => {
    try {
      const cfgRes = await ep1.get("/api/v2/conductexam2/configuration", { params: { colid } });
  ...
  const loadData = async () => {
    try {
      ...
      const [allotmentsRes, examinersRes] = await Promise.allSettled([
        ep1.get("/api/v2/conductexam2/examiner-allotments", { params: { colid } }),
        ep1.get("/api/v2/conductexam2/examiners", { params: { colid } })
      ]);
  ...
  return (
    <MenuPageShell title="Examiner Allotment Report 2">
        ...
        <Box className="screen-only" sx={{ mb: 2.5 }}>
          ...
          <Accordion sx={{ mb: 2, borderRadius: "8px !important", border: "1px solid #cbd5e1" }}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography fontWeight={700} color="#334155">ðŸ“ Edit Document Details</Typography>
            </AccordionSummary>
            <AccordionDetails>
            ...
            >
              ...
              <Box sx={{ pl: 1, mt: 1 }}>
                ...
                <Typography sx={{ fontSize: "11px", color: "#000", pl: 2, mb: 0.2 }}>
                  â€¢ &nbsp;<strong>In-Charge (Conduct)</strong> - for coordination with HOI/HOD of the institute.
                </Typography>
                <Typography sx={{ fontSize: "11px", color: "#000", pl: 2 }}>
                  â€¢ &nbsp;<strong>Assistant Registrar (Evaluation)</strong> - for coordination with HOI/HOD regarding Evaluation.
                </Typography>
              </Box>
            </Card>
          )}
