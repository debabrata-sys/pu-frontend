...
export default function FeedbackInternalAnalytics() {
  ...
  const fetchAnalytics = async () => {
    try {
      const res = await ep1.get("/api/v2/getfeedbackinternalanalyticsds", {
                  ...
                  <Box>
                    ...
                    <Box sx={{ height: 300, mb: 2 }}>
                      <ResponsiveContainer width="100%" height="100%">
                        <RechartsBarChart
                          data={Object.entries(question.ratingCounts).map(
                            ([rating, count]) => ({
                        ...
                        >
                          ...
                          <Bar
                            ...
                            radius={[4, 4, 0, 0]}
                          >
                            {Object.entries(question.ratingCounts).map(
                              (entry, index) => (
                                <Cell
                                  key={`cell-${index}`}
                                  fill={COLORS[index]}
