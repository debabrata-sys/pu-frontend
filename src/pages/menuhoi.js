...
{open && <ListItemText primaryTypographyProps={{fontSize: "14px"}} primary="AI Chatbot" />}
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <ListItem button component={RouterLink} to="/FacultyRequestApprovalds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Request Approve" />}
          </ListItem>
          <ListItem button component={RouterLink} to="/ApprovalConfigurationds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Config PO Approver" />}
          </ListItem>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <ListItem button component={RouterLink} to="/admin/admission-info-report-excel">
            <ListItemIcon>
              <FileDownloadIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: '14px' }} primary="Admission Excel Report" />}
          </ListItem>
      ...
      <Accordion>
        <AccordionSummary aria-controls="panel2-content" id="panel2-header">
          <SettingsIcon sx={{ marginRight: 1 }} />
          {open && <Typography sx={{ fontSize: 14 }}>Admission data management</Typography>}
        </AccordionSummary>
        <AccordionDetails>
      ...
      {open && <ListItemText primaryTypographyProps={{fontSize: "14px"}} primary="Video page" />}
          ...
          <ListItem button component={RouterLink} to="/attendancetimereportds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Attendance Time Report" />}
          </ListItem>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <ListItem button component={RouterLink} to="/paymentgatewayconfigds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Payment Gateway Configuration" />}
          </ListItem>
          <ListItem button component={RouterLink} to="/platformchargesds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Platform Charges" />}
          </ListItem>
          <ListItem button component={RouterLink} to="/couponmanagementds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Coupon Management" />}
          </ListItem>
          <ListItem button component={RouterLink} to="/paymentinitiationds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
            {open && <ListItemText primaryTypographyProps={{ fontSize: "14px" }} primary="Payment Initiation" />}
          </ListItem>
          <ListItem button component={RouterLink} to="/paymenthistoryds">
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
