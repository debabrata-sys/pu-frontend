  ...
  return (
    ...
    <Container maxWidth="100%" sx={{ mt: 4, mb: 4 }}>
      <Paper elevation={1} sx={{ p: 3 }}>
        ...
        <p>
          Validate your documents using AI against the data you have entered and get a score.
        </p>
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td width="20px"></td>
              <td>
                <Button variant="contained"  sx={{  width: 180 }} onClick={processpdf}>
                  Check PDF
                </Button>
              </td>
            </tr>
            <tr>
              ...
              <td>
               ...
               <td width="20px"></td>
              <td>
                <Button variant="contained"  sx={{ width: 180 }} onClick={extractImageText}>
                  Check Image (OCR)
                </Button>
              </td>
            </tr>
