...
const CreateGrievanceFormds1 = () => {
  ...
  const fetchMyGrievances = async () => {
    ...
    try {
      const response = await ep1.get('/api/v2/getgrievancesbyuserds1', {
        params: {
          colid: global1.colid,
          user: global1.user,
          regno: global1.regno,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await ep1.post('/api/v2/addgrievanceds1', payload);
...
export default CreateGrievanceFormds1;
