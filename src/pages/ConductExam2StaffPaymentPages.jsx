...
const configs = {
  examiner: {
    ...
    endpoint: "/api/v2/conductexam2/examiner-payment",
  ...
  moderator: {
    ...
    endpoint: "/api/v2/conductexam2/moderator-payment",
  ...
  papersetter: {
    ...
    endpoint: "/api/v2/conductexam2/papersetter-payment",
...
function ConductExamStaffPaymentPage({ mode }) {
  ...
  const loadOptions = async () => {
    const res = await ep1.get("/api/v2/conductexam2/payment-options", { params: { colid: global1.colid, mode } });
...
export const ConductExam2ExaminerPaymentPage = () => <ConductExamStaffPaymentPage mode="examiner" />;
export const ConductExam2ModeratorPaymentPage = () => <ConductExamStaffPaymentPage mode="moderator" />;
export const ConductExam2PaperSetterPaymentPage = () => <ConductExamStaffPaymentPage mode="papersetter" />;
